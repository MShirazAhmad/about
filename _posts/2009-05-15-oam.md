---
title: "Optical communication system based on *LASER* beams carrying *Orital
angular momentum*"
categories:
  - MATLAB
tags:
...
![Phase front with $\ell=-3$ as there two curved (anticlockwise)
surfaces, so It has -3 OAM[]{label="l3b"}](https://shiraz-ahmad.com/assets/images/oam/l1a.png){#l3b width="\textwidth"}

\hfill
![Phase front with $\ell=-3$ as there two curved (anticlockwise)
surfaces, so It has -3 OAM[]{label="l3b"}](https://shiraz-ahmad.com/assets/images/oam/l1b.png){#l3b width="\textwidth"}

![Phase front with $\ell=-3$ as there two curved (anticlockwise)
surfaces, so It has -3 OAM[]{label="l3b"}](https://shiraz-ahmad.com/assets/images/oam/l2a.png){#l3b width="\textwidth"}

\hfill
![Phase front with $\ell=-3$ as there two curved (anticlockwise)
surfaces, so It has -3 OAM[]{label="l3b"}](https://shiraz-ahmad.com/assets/images/oam/l2b.png){#l3b width="\textwidth"}

![Phase front with $\ell=-3$ as there two curved (anticlockwise)
surfaces, so It has -3 OAM[]{label="l3b"}](https://shiraz-ahmad.com/assets/images/oam/l3a.png){#l3b width="\textwidth"}

\hfill
![Phase front with $\ell=-3$ as there two curved (anticlockwise)
surfaces, so It has -3 OAM[]{label="l3b"}](https://shiraz-ahmad.com/assets/images/oam/l3b.png){#l3b width="\textwidth"}
...
![[]{label="SLMl3"}](https://shiraz-ahmad.com/assets/images/oam/0.png){#SLMl3 width="\textwidth"}

\hfill
![[]{label="SLMl3"}](https://shiraz-ahmad.com/assets/images/oam/1.png){#SLMl3 width="\textwidth"}

![[]{label="SLMl3"}](https://shiraz-ahmad.com/assets/images/oam/2.png){#SLMl3 width="\textwidth"}

\hfill
![[]{label="SLMl3"}](https://shiraz-ahmad.com/assets/images/oam/3.png){#SLMl3 width="\textwidth"}
...
wave-front.](https://shiraz-ahmad.com/assets/images/oam/MacZ0){width="\textwidth"}

\hfill
![**Fig.5** Interference pattern of Maczander Interferometry, when beam
carrying *OAM* is interfered with wave having plane
wave-front.](https://shiraz-ahmad.com/assets/images/oam/MacZ1.png){width="\textwidth"}

\hfill
![**Fig.5** Interference pattern of Maczander Interferometry, when beam
carrying *OAM* is interfered with wave having plane
wave-front.](https://shiraz-ahmad.com/assets/images/oam/MacZ2.png){width="\textwidth"}

\hfill
![**Fig.5** Interference pattern of Maczander Interferometry, when beam
carrying *OAM* is interfered with wave having plane
wave-front.](https://shiraz-ahmad.com/assets/images/oam/MacZ3.png){width="\textwidth"}
