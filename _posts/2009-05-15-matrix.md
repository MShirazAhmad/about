...
Experimental setup is shown in Figure [7](#fig:Schematic diagram){reference-type="ref" reference="fig:Schematic diagram"}. We used two transparent materials of thickness 1 mm, 2.288 mm having refractive indices $1.47, 1.5007$ (at $\lambda = 1547 nm$) with separation of 0.302 mm and placed on a rotating table. Optical power sensor that can be rotated along the table to measure transmitted/reflected beam. Actual setup is shown in Figure [6](#fig:setup){reference-type="ref" reference="fig:setup"} and measured reflection and transmission coefficients for $\theta_i \text{from } {1} \text{ to } {90}$ and measured corresponding transmission and reflection power amplitudes, for both $s$ and $p$ polarized optical beams.
